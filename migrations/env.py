"""Alembic migrations environment — configured for SQLModel + AgentLoop."""
...
# AgentLoop models (must import so metadata is populated)
from agentloop.models import (  # noqa: F401
    Agent, Event, Mission, Proposal, Project, Step, Trigger,
)
