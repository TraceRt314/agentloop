...
export default function SystemPanel() {
  ...
  if (loading) {
    return <div className="p-6 text-center text-slate-600 pixel-font text-xs animate-pulse">Checking systems...</div>;
  }
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      {/* Services */}
      <div>
        <h3 className="pixel-font text-xs text-slate-400 mb-4 flex items-center gap-2">
          ...
          {Object.entries(services).map(([name, svc]) => {
            ...
            return (
              ...
              >
                ...
                <div className={`pixel-font mt-2 ${isHealthy ? "text-green-400" : "text-red-400"}`} style={{ fontSize: 8 }}>
              ...
              {[
                ...
                >
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="pixel-font text-2xl" style={{ color: stat.color }}>{stat.value}</span>
                  </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              {overview.projects.map((p) => (
                <div key={p.slug} className="p-3 rounded-lg border border-slate-700/30 bg-slate-800/20">
                  ...
                  <div className="pixel-font text-slate-600 mt-1" style={{ fontSize: 8 }}>{p.slug}</div>
                </div>
              ))}
            </div>
          </div>
              ...
              {overview.agents.map((a) => {
                ...
                return (
                  <div key={a.name} className="p-3 rounded-lg border border-slate-700/30 bg-slate-800/20 text-center">
                    ...
                    <div
                      className="pixel-font mt-2 px-2 py-1 rounded-full inline-block"
                      style={{
                        fontSize: 8,
