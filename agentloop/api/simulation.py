...
from ..models import (
    Agent, AgentAction, AgentStatus, Event, Project, Step, StepStatus,
    Mission, MissionStatus, Proposal, ProposalPriority, ProposalStatus,
)
...
def sync_mission_control(session: Session = Depends(get_session)):
    ...
    # ── Inbound: MC tasks → AgentLoop proposals ──
    for board_id, project_slug in BOARD_PROJECT_MAP.items():
        ...
        # Pick the first active agent for this project as the proposer
        ...
        for task in tasks:
            ...
            # Dedup: skip if proposal already exists for this MC task
            ...
            # Map MC priority to ProposalPriority
        ...
        for mission in completed_missions:
            ...
            from ..integrations.mission_control import report_agent_activity, update_task_status
